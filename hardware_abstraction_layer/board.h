...
#define MOTOR_2_MAGNITUDE_GPIO_PORT                             GPIO_PORT_P1
#define MOTOR_2_MAGNITUDE_GPIO_PIN                              GPIO_PIN6
#define MOTOR_2_MAGNITUDE_TIMER_AX_BASE_ADDRESS                 TIMER_A0_BASE
#define MOTOR_2_MAGNITUDE_TIMER_AX_CAPCOMP_REG                  TIMER_A_CAPTURECOMPARE_REGISTER_2
#define MOTOR_2_MAGNITUDE_GPIO_TIMER_AX_CHANNEL_MODULE_FUNCTION GPIO_PRIMARY_MODULE_FUNCTION
#define MOTOR_2_DIRECTION_ENABLE_1_GPIO_PORT                    GPIO_PORT_P5
#define MOTOR_2_DIRECTION_ENABLE_1_GPIO_PIN                     GPIO_PIN3
#define MOTOR_2_DIRECTION_ENABLE_2_GPIO_PORT                    GPIO_PORT_P1
#define MOTOR_2_DIRECTION_ENABLE_2_GPIO_PIN                     GPIO_PIN3
...
#define ENCODER_2_SIGNAL_A_GPIO_PORT        GPIO_PORT_P2
#define ENCODER_2_SIGNAL_A_GPIO_PIN         GPIO_PIN7
#define ENCODER_2_SIGNAL_B_GPIO_PORT        GPIO_PORT_P2
#define ENCODER_2_SIGNAL_B_GPIO_PIN         GPIO_PIN5
...
#define LIMIT_SWITCH_LINKAGE_1_HOME_GPIO_PORT       GPIO_PORT_P2
#define LIMIT_SWITCH_LINKAGE_1_HOME_GPIO_PIN        GPIO_PIN7
...
#define PUSHBUTTON_S2_GPIO_PORT     GPIO_PORT_P2
#define PUSHBUTTON_S2_GPIO_PIN      GPIO_PIN6
